...
@section('seo')
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="{{ env('APP_URL') }}/blog/none-do-post" />
@endsection
@section('content')
    <section class="post-header"
        style="background:linear-gradient(0deg,rgba(4, 37, 83, 0.753),rgba(20, 167, 212, 0.534)),url('/{{ $post->image }}');"
        data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters  align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate mb-5 text-center">
                    <h1 class="mb-3 bread text-white">{!! $post->title !!}</h1>
                    <p class="breadcrumbs text-white">{!! $post->excerpt !!}</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        ...
                        <div class="article-box">
                            <header class="article-header" style="background-image: url('/{{ $post->image }}')">
                            </header>
                            <main class="article-body">
                                <h1 class="article-title">{!! $post->title !!}</h1>
                                <div class="alert bg-light article-details">
                                    <p><i class="fas fa-chalkboard-teacher"></i> {{ @$post->author->name }} &nbsp; <i
                                            class="fas fa-calendar"></i>
                                        {{ Carbon\Carbon::create($post->publish)->format('d/m/Y') }}</p>
                                </div>
                                {!! $post->body !!}
                            </main>
                        </div>
                        <div class="paginate-box bg-light mb-30">
                            <div class="block-27">
                                <div class="text-center">
                                    <h5><i class="fas fa-external-link-alt"></i> Compartilhe este post em suas redes:</h5>
                                </div>
